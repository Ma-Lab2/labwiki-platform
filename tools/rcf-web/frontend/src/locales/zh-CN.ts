export default {
  ...
  intro: {
    ...
    summary: '用于组织叠层、估算截止能量、导出参数快照与响应矩阵，并把结果回填到 Shot 页面和数据目录。',
    step1: '先设置入射粒子、能区和角度',
    step2: '再整理层序并运行计算',
  ...
  sections: {
    ...
    archiveNote: '计算完成后，把工具入口、参数快照、结果摘要截图、响应矩阵和原始数据路径登记到 Shot 页面。',
  },
  header: {
    badge: '内部诊断工具',
    summary: '与 private wiki 的 Diagnostic、Data、Shot 页面共用同一套归档字段。',
    lang: '语言',
    reference: '工具说明',
    archive: '归档字段',
